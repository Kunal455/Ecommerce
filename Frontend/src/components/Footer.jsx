...
import { Send, CheckCircle, AlertCircle, Instagram } from 'lucide-react'
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1">
            ...
            <div className="flex items-center gap-4">
              <a href="https://www.instagram.com/vermakunal_01/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#1a2b4c] flex items-center justify-center text-gray-400 hover:text-white hover:bg-gradient-to-tr hover:from-yellow-400 hover:via-pink-500 hover:to-purple-500 transition-all shadow-sm">
                <Instagram size={18} />
              </a>
              <a href="https://wa.me/919128744294" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#1a2b4c] flex items-center justify-center text-gray-400 hover:text-white hover:bg-[#25D366] transition-all shadow-sm">
