        ...
        <div className="flex-1 overflow-y-auto pt-6">
          {isAuthenticated ? (
            <div className="px-6 mb-8 text-center">
              <div className="w-16 h-16 bg-[#f9fafb] rounded-full mx-auto flex items-center justify-center mb-4">
          ...
          <div className="flex flex-col">
            ...
            <Link to="/wishlist" onClick={closeProfile} className="px-6 py-4 hover:bg-[#f9fafb] text-[12px] font-bold tracking-[0.15em] text-[#101828] uppercase transition-colors border-l-2 border-transparent hover:border-[#c9a84c]">Wishlist</Link>
          </div>
        </div>
